...
# # --- MongoDB Setup
# mongo_client = MongoClient("mongodb://192.168.1.102:27017/?serverSelectionTimeoutMS=3000")
# mongo_db = mongo_client["monitoringsystem"]
# mongo_col = mongo_db["app_usage_logs_2"]

# # --- Milvus Setup
# connections.connect("default", host="localhost", port="19530")

# milvus_collection_name = "usage_vectors"
